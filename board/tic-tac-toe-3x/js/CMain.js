function CMain(oData){
    ...
    this._initSounds = function(){
        ...
        s_aSoundsInfo.push({path: './sounds/',filename:'place_mark',loop:false,volume:1, ingamename: 'place_mark'});
        ...
        s_aSoundsInfo.push({path: './sounds/',filename:'draw',loop:false,volume:1, ingamename: 'draw'});
