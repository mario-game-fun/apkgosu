function CGame(oData){
    ...
    this.initMatrix = function(){
        for (var y = 0; y < _iMatrixSize; y++) {
            ...
            for (var x = 0; x < _iMatrixSize; x++) {
                ...
                iY = y*(CELL_SIZE + CELL_PADDING)*fScaling;
    ...
    s_oGame = this;
    POINTS_EARNED = oData.single_player_score_earned;
    this._init(oData);
}
