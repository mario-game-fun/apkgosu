( () => {
    ...
    try {
        try {
            ...
            c = function(t) {
                ...
                for (var n = Array(t.length >> 2), o = 0; o < n.length; o++)
                    n[o] = 0;
                for (o = 0; o < 8 * t.length; o += 8)
                    n[o >> 5] |= (255 & t.charCodeAt(o / 8)) << o % 32;
                return n
            }(u = t), 8 * u.length))).toLowerCase()
        } catch (t) {}
    ...
    if (window.location.href.indexOf("pokiForceLocalLoader") >= 0 && (l.unity = "/unity/dist/unity.js",
    ...
    if (!window.config.unityWebglLoaderUrl) {
        const t = window.config.unityVersion ? window.config.unityVersion.split(".") : []
          ...
          , o = t[1];
        if ("2019" === n)
            window.config.unityWebglLoaderUrl = 1 === o ? "./loaders/v2/unity/static/UnityLoader.2019.1.js" : "./loaders/v2/unity/static/UnityLoader.2019.2.js";
        else
            window.config.unityWebglLoaderUrl = "./loaders/v2/unity/static/UnityLoader.js"
    }
    const y = document.createElement("script");
    y.src = "https://www.apkgosu.fun/ad/sdk/sdk.js",
    y.onload = () => {
