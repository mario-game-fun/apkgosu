...
window.DOMHandler = class {
    ...
    _PostToRuntimeMaybeSync(e, t, i) {
        this._iRuntime.UsesWorker() ? this.PostToRuntime(e, t, i) : this._iRuntime._OnLocalRuntimeMessageFromDOM({
            type: "event",
    ...
    AddRuntimeMessageHandlers(e) {
        for (const [t,i] of e)
            this.AddRuntimeMessageHandler(t, i)
    }
    GetRuntimeInterface() {
...
window.RateLimiter = class {
    ...
    Call() {
        ...
        const e = Date.now()
          ...
          , i = this._interval;
        t >= i && this._canRunImmediate ? (this._lastCallTime = e,
        this._RunCallback()) : this._timerId = self.setTimeout(this._timerCallFunc, Math.max(i - t, 4))
    }
    _RunCallback() {
        this._ignoreReset = !0,
        this._callback(),
...
;
{
    ...
    window.DOMElementHandler = class extends self.DOMHandler {
        ...
        AddDOMElementMessageHandlers(e) {
            for (const [t,i] of e)
                this.AddDOMElementMessageHandler(t, i)
        }
        _OnCreate(t) {
            const i = t.elementId
              , s = this.CreateElement(i, t)
              , n = new e(s);
            this._elementMap.set(i, n),
            s.style.boxSizing = "border-box",
            s.style.display = "none",
            n.SetVisibleFlag(t.isVisible);
            const a = this._GetFocusElement(s);
            a.addEventListener("focus", e => this._OnFocus(i)),
            a.addEventListener("blur", e => this._OnBlur(i));
            const o = t.htmlIndex;
            if (n.SetWantHTMLIndex(o),
            n.SetHTMLZIndex(t.htmlZIndex),
            this._autoAttach) {
                const e = this.GetRuntimeInterface().GetAvailableHTMLIndex(o);
                n.SetActualHTMLIndex(e),
        ...
        _OnDestroy(e) {
            ...
            this._autoAttach && i.parentElement.removeChild(i),
            this._elementMap.delete(t)
        }
        PostToRuntimeElement(e, t, i) {
            i || (i = {}),
            i.elementId = t,
            this.PostToRuntime(e, i)
        }
        _PostToRuntimeElementMaybeSync(e, t, i) {
            i || (i = {}),
            i.elementId = t,
            this._PostToRuntimeMaybeSync(e, i)
        }
        _OnSetVisible(e) {
            if (!this._autoAttach)
                return;
        ...
        _OnUpdatePosition(e) {
            ...
            o !== t.GetActualHTMLIndex() && (i.remove(),
            s.GetHTMLWrapElement(o).appendChild(i),
            t.SetActualHTMLIndex(o),
            s._UpdateHTMLElementsZOrder());
            const r = e.htmlZIndex;
            r !== t.GetHTMLZIndex() && (t.SetHTMLZIndex(r),
            s._UpdateHTMLElementsZOrder()),
            t.HadFirstUpdate() || (t.SetHadFirstUpdate(),
            t.GetVisibleFlag() && (i.style.display = ""))
        }
            ...
            if (this._autoAttach)
                for (const e of this._elementMap.values()) {
                    ...
                    if (-1 !== t && -1 !== i && t !== i) {
                        ...
                        i.remove(),
                        this.GetRuntimeInterface().GetHTMLWrapElement(t).appendChild(i),
...
}
{
    const t = /(iphone|ipod|ipad|macos|macintosh|mac os x)/i.test(navigator.userAgent)
      ...
      , d = /safari/i.test(navigator.userAgent) && !/(chrome|chromium|edg\/|OPR\/)/i.test(navigator.userAgent);
    let l = 0;
    function c(e) {
        const t = document.createElement("script");
        return t.async = !1,
        t.type = "module",
        e.isStringSrc ? new Promise(i => {
            const s = "c3_resolve_" + l;
            ++l,
            self[s] = i,
            t.textContent = e.str + `\n\nself["${s}"]();`,
    ...
    let _ = new Audio;
    const m = {
        "audio/webm; codecs=opus": !!_.canPlayType("audio/webm; codecs=opus"),
        "audio/ogg; codecs=opus": !!_.canPlayType("audio/ogg; codecs=opus"),
        "audio/webm; codecs=vorbis": !!_.canPlayType("audio/webm; codecs=vorbis"),
        "audio/ogg; codecs=vorbis": !!_.canPlayType("audio/ogg; codecs=vorbis"),
        "audio/mp4": !!_.canPlayType("audio/mp4"),
        "audio/mpeg": !!_.canPlayType("audio/mpeg")
    };
    _ = null,
    ...
    ;
    const R = new Set(["cordova", "playable-ad-single-file", "playable-ad-zip", "instant-games"]);
    function O(e) {
        return R.has(e)
    }
    let I = !1;
    window.RuntimeInterface = class e {
        ...
        constructor(e) {
            ...
            this.#s = e.scriptFolder,
            this.#A = e.exportType,
            "playable-ad-single-file" !== this.#A && "playable-ad-zip" !== this.#A && "instant-games" !== this.#A || (this.#e = !1),
            (d || "macos-wkwebview" === this.#A) && (this.#e = !1),
            "cordova" === this.#A && this.#e && n) {
                const e = /Chrome\/(\d+)/i.exec(navigator.userAgent);
                e && parseInt(e[1], 10) >= 90 || (this.#e = !1)
            }
            this.IsAnyWebView2Wrapper() ? self.chrome.webview.addEventListener("message", e => this.#R(e.data, e.additionalObjects)) : "macos-wkwebview" === this.#A ? self.C3WrapperOnMessage = e => this.#R(JSON.parse(e)) : "linux-cef" === this.#A && self.c3_linux_cef_set_message_callback(e => this.#R(JSON.parse(e))),
            ...
            this.AddRuntimeComponentMessageHandler("canvas", "update-size", e => this.#k(e)),
            this.AddRuntimeComponentMessageHandler("canvas", "set-html-layer-count", e => this._OnSetHTMLLayerCount(e)),
            this.AddRuntimeComponentMessageHandler("canvas", "cleanup-html-layers", () => this.#E()),
            this.AddRuntimeComponentMessageHandler("canvas", "update-html-layer-dom-state", e => this.#O(e.layersDomState)),
            this.AddRuntimeComponentMessageHandler("runtime", "create-job-worker", e => this.#I(e)),
            this.AddRuntimeComponentMessageHandler("runtime", "send-wrapper-extension-message", e => this.#T(e)),
            this.AddRuntimeComponentMessageHandler("runtime", "send-raw-wrapper-extension-message", e => this.#M(e)),
            "cordova" === this.#A ? document.addEventListener("deviceready", () => this.#G(e)) : this.#G(e),
        ...
        Release() {
            ...
            this.#t = null),
            this.#n && (this.#n.terminate(),
            this.#n = null),
            this.#a && (this.#a.Release(),
            this.#a = null);
            for (const {canvas: e, htmlWrap: t} of this.#l)
                e.remove(),
                t.remove();
            this.#l.length = 0
        }
        GetMainCanvas() {
            return this.#l[0].canvas
        }
        GetAvailableHTMLIndex(e) {
            return Math.min(e, this.#l.length - 1)
        }
        GetHTMLWrapElement(e) {
            if (e < 0 || e >= this.#l.length)
                throw new RangeError("invalid canvas layer");
            return this.#l[e].htmlWrap
        }
        ...
        IsiOSCordova() {
            return t && "cordova" === this.#A
        }
        IsiOSWebView() {
            const e = navigator.userAgent;
            return t && O(this.#A) || navigator.standalone || /crios\/|fxios\/|edgios\//i.test(e)
        }
        IsAndroid() {
            return n
        }
        ...
        IsWindowsWebView2() {
            return "windows-webview2" === this.#A || !!("preview" === this.#A && window.chrome && window.chrome.webview && window.chrome.webview.postMessage)
        }
        IsAnyWebView2Wrapper() {
            return this.IsWindowsWebView2() || "xbox-uwp-webview2" === this.#A
        }
        ...
        *_CanDoAndroidVirtualKeyboardDetection() {
        ...
        async #G(e) {
            if (this.#e && (await u() || (this.#e = !1)),
            "macos-wkwebview" === this.#A && this._SendWrapperMessage({
                type: "ready"
            }),
            this.IsAnyWebView2Wrapper() || "macos-wkwebview" === this.#A || "linux-cef" === this.#A) {
                this.#N();
                const e = await this.#x();
                this.#S = e.registeredComponentIds
            }
            if ("playable-ad-single-file" === this.#A && (this._localFileBlobs = self.c3_base64files,
            this._localFileStrings = {},
            await this.#L()),
            e.runtimeBaseUrl)
                this.#i = e.runtimeBaseUrl;
            else {
                const e = location.origin;
                this.#i = ("null" === e ? "file:///" : e) + location.pathname;
                const t = this.#i.lastIndexOf("/");
                -1 !== t && (this.#i = this.#i.substr(0, t + 1))
            }
            const t = new MessageChannel;
            if (this.#t = t.port1,
            this.#t.onmessage = e => this._OnMessageFromRuntime(e.data),
            window.c3_addPortMessageHandler && window.c3_addPortMessageHandler(e => this.#D(e)),
            this.#f = new self.JobSchedulerDOM(this),
            await this.#f.Init(),
            ...
            this.#e ? await this.#H(e, t.port2) : await this.#F(e, t.port2)
        }
        #W(t) {
            return {
                ...
                ife: !!self.ife,
                jobScheduler: this.#f.GetPortData(),
        ...
        async #H(e, t) {
            ...
            "preview" === this.#A ? (this.#n = new Worker("previewworker.js",{
                type: "module",
                name: "Runtime"
            }),
            await new Promise( (e, t) => {
                const s = i => {
                    this.#n.removeEventListener("message", s),
                    i.data && "ok" === i.data.type ? e() : t()
                }
                ;
                this.#n.addEventListener("message", s),
                this.#n.postMessage({
                    type: "construct-worker-init",
                    import: new URL(i,this.#i).toString()
                })
            }
            )) : this.#n = await this.CreateWorker(i, {
                type: "module",
                name: "Runtime"
            });
            ...
            this.#n.postMessage(Object.assign(this.#W(e), {
                type: "init-runtime",
                isInWorker: !0,
                messagePort: t,
                canvas: n,
                runtimeMainScript: e.runtimeMainScript,
            ...
            }), [t, n, ...this.#f.GetPortTransferables()]),
            this.#o = w.map(e => new e(this)),
            this.#U(),
            this.#r._AddDefaultCanvasEventHandlers(s),
            this.#r._AddDefaultHTMLWrapEventHandlers(a),
            this.#r._EnableWindowResizeEvent(),
            self.c3_callFunction = (e, t) => this.#r._InvokeFunctionFromJS(e, t),
            "preview" === this.#A && (self.goToLastErrorScript = () => this.PostToRuntimeComponent("runtime", "go-to-last-error-script"))
        }
        async #F(e, t) {
            ...
            s.className = "c3htmlwrap",
            s.setAttribute("interactive", ""),
            document.body.appendChild(s),
            this.#l.push({
                canvas: i,
                htmlWrap: s,
            ...
            this.#o = w.map(e => new e(this)),
            this.#U(),
            this.#r._AddDefaultCanvasEventHandlers(i),
            this.#r._AddDefaultHTMLWrapEventHandlers(s);
            const n = await this.#B(e.runtimeMainScript);
            let a, o;
            globalThis.C3_SetInitFunctions = (e, t) => {
                a = e,
                o = t,
            ...
            ,
            await c(n);
            const r = e.projectMainScriptPath
              , d = e.javaScriptInEventsPath
              , l = e.typeScriptInEventsPath;
            if (r)
                try {
                    if (await c(r),
                    "preview" === this.#A && !globalThis.C3_ProjectMainScriptOK)
                        throw new Error("main script did not run to completion")
                } catch (e) {
                    this.#V(),
                    console.error("Error loading project main script: ", e),
                    alert(`Failed to load the project main script (${r}). Check all your JavaScript code has valid syntax, all imports are written correctly, and that an exception was not thrown running the script. Press F12 and check the console for error details.`)
                }
            if (d)
                try {
                    if (await c(d),
                    "preview" === this.#A && !globalThis.C3.JavaScriptInEvents)
            ...
            if (l)
                try {
                    if (await c(l),
                    "preview" === this.#A && !globalThis.C3.TypeScriptInEvents)
            ...
            const h = Object.assign(this.#W(e), {
                isInWorker: !1,
                messagePort: t,
                canvas: i,
        ...
        async CreateWorker(e, t) {
            ...
            if ("playable-ad-single-file" === this.#A) {
        ...
        async #I(e) {
            const t = await this.#f._CreateJobWorker();
            return {
                outputPort: t,
                transferables: [t]
            }
        ...
        #k(e) {
            ...
            const t = e.styleWidth + "px"
              ...
              , s = e.marginLeft + "px"
              , n = e.marginTop + "px";
            for (const {canvas: e, htmlWrap: a} of this.#l)
                e.style.width = t,
                e.style.height = i,
                e.style.marginLeft = s,
                e.style.marginTop = n,
                a.style.width = t,
                a.style.height = i,
                a.style.marginLeft = s,
                a.style.marginTop = n,
                this.#d && (e.style.display = "",
                a.style.display = "");
        ...
        _OnSetHTMLLayerCount(e) {
            ...
            if (t < this.#l.length)
                for (; this.#l.length > t; ) {
                    const {canvas: e, htmlWrap: t} = this.#l.pop();
                    t.remove(),
                    this.#e && !s ? this.#h.push(e) : e.remove()
                }
            else if (t > this.#l.length)
                for (let e = 0, i = t - this.#l.length; e < i; ++e) {
                    ...
                    e.style.width = n,
                    e.style.height = a,
                    e.style.marginLeft = o,
                    e.style.marginTop = r,
                    t.style.width = n,
                    t.style.height = a,
                    t.style.marginLeft = o,
                    t.style.marginTop = r,
                    this.#r._AddDefaultCanvasEventHandlers(e),
                    this.#r._AddDefaultHTMLWrapEventHandlers(t),
                    this.#l.push({
                        canvas: e,
                        htmlWrap: t,
                        lastHtmlLayerDomState: {
        ...
        #O(e) {
            for (let t = 0, i = Math.min(this.#l.length, e.length); t < i; ++t) {
                const {htmlWrap: i, lastHtmlLayerDomState: s} = this.#l[t]
                  , n = e[t]
                  , a = n.isVisible
                  , o = n.opacity
                  , r = n.isInteractive;
                a !== s.isVisible && (i.style.display = a ? "" : "none",
                s.isVisible = a),
                o !== s.opacity && (i.style.opacity = 1 === o ? "" : String(o),
                s.opacity = o),
                r !== s.isInteractive && (i.style.pointerEvents = r ? "" : "none",
                r ? i.setAttribute("interactive", "") : i.removeAttribute("interactive"),
                s.isInteractive = r)
            }
        }
        #E() {
        ...
        _UpdateHTMLElementsZOrder() {
            this.#c || (this.#c = !0,
            this._AddRAFCallback(this.#u))
        }
        #_() {
            this._RemoveRAFCallback(this.#u),
            this.#c = !1;
            let e = [];
            ...
            for (; s < n; ++s) {
                const n = e[s];
                n.GetActualHTMLIndex() !== t && (this.#z(t, e.slice(i, s)),
                t = n.GetActualHTMLIndex(),
                i = s)
            }
            i < s && this.#z(t, e.slice(i, s))
        }
        #z(e, t) {
            if (t.length <= 1)
                return;
        ...
        #X(e) {
            ...
            const o = a.get(i);
            if (!o)
                return void console.warn(`[DOM] No handler '${i}' for component '${t}'`);
            let r = null;
            try {
                r = o(s)
            } catch (e) {
                return console.error(`Exception in '${t}' handler '${i}':`, e),
                void (null !== n && this.#Y(n, !1, "" + e))
            }
            if (null === n)
                return r;
            r && r.then ? r.then(e => this.#Y(n, !0, e)).catch(e => {
                console.error(`Rejection from '${t}' handler '${i}':`, e),
                this.#Y(n, !1, "" + e)
            }
            ) : this.#Y(n, !0, r)
        }
        #Y(e, t, i) {
            let s;
            i && i.transferables && (s = i.transferables),
            this.#t.postMessage({
                type: "result",
                responseId: e,
                isOk: t,
        ...
        static IsDocumentFullscreen() {
            return !!(document.fullscreenElement || document.webkitFullscreenElement || document.mozFullScreenElement || I)
        }
        ...
        _RemoveRAFCallback(e) {
            this.#v.delete(e),
            0 === this.#v.size && this._CancelAnimationFrame()
        }
        _RequestAnimationFrame() {
            -1 === this.#g && this.#v.size > 0 && (this.#g = requestAnimationFrame(this.#w))
        }
        ...
        TryPlayMedia(e) {
            this.#r.TryPlayMedia(e)
        }
        RemovePendingPlay(e) {
            this.#r.RemovePendingPlay(e)
        }
        _PlayPendingMedia() {
            this.#r._PlayPendingMedia()
        }
        AddAnyGamepadInputCallback(e) {
            this.#r._AddAnyGamepadInputCallback(e)
        }
        RemoveAnyGamepadInputCallback(e) {
            this.#r._RemoveAnyGamepadInputCallback(e)
        }
        SetSilent(e) {
            this.#r.SetSilent(e)
        }
        ...
        #J(e) {
            const t = this.#$();
            return new Promise( (i, s) => t.checkPermission(this.#Z(t, e), e => i(!!e.hasPermission), s))
        }
        #Q(e) {
            const t = this.#$();
            return new Promise( (i, s) => t.requestPermission(this.#Z(t, e), e => i(!!e.hasPermission), s))
        }
        async RequestPermissions(e) {
            ...
            if (this.IsiOSCordova())
                return !0;
            for (const t of e)
                if (!await this.#J(t) && !1 === await this.#Q(t))
                    return !1;
            return !0
        }
        ...
        #R(t, i) {
            if ("object" != typeof t || !t)
                return void console.warn("Unknown wrapper message: ", t);
            const s = t.type;
            if ("directory-handles" === s)
                ...
                e._SetWrapperIsFullscreenFlag(t.isFullscreen),
                this.#r._OnFullscreenChange();
            ...
            } else if ("extension-message" === s)
                this.PostToRuntimeComponent("runtime", "wrapper-extension-message", t);
            else {
                const e = this.#C.get(s);
                e ? e(t) : console.warn("Unknown wrapper message: ", t)
            }
        }
        _AddWrapperMessageHandler(e, t) {
            this.#C.set(e, t)
        }
        #T(e) {
        ...
        _SendWrapperMessage(e) {
            this.IsAnyWebView2Wrapper() ? window.chrome.webview.postMessage(JSON.stringify(e)) : "macos-wkwebview" === this.#A ? window.webkit.messageHandlers.C3Wrapper.postMessage(JSON.stringify(e)) : "linux-cef" === this.#A && window.c3_linux_cef_sendmessage(JSON.stringify(e))
        }
        #N() {
            window.moveTo = (e, t) => {
                this._SendWrapperMessage({
        ...
        async #L() {
            const e = [];
            for (const [t,i] of Object.entries(this._localFileBlobs))
                e.push(this.#ee(t, i));
            await Promise.all(e)
        }
        async #ee(e, t) {
            if ("object" == typeof t)
                ...
                let i = await this.#te(t);
                i || (i = this.#ie(t)),
                this._localFileBlobs[e] = i
            }
        }
        async #te(e) {
            try {
        ...
        #ne(e, t) {
            let i, s, n = e.length, a = n >> 2, o = new Uint8Array(n), r = new Uint32Array(o.buffer,0,a);
            for (i = 0,
            s = 0; i < a; ++i)
                r[i] = e.charCodeAt(s++) | e.charCodeAt(s++) << 8 | e.charCodeAt(s++) << 16 | e.charCodeAt(s++) << 24;
            let d = 3 & n;
            for (; d--; )
                o[s] = e.charCodeAt(s),
                ++s;
...
}
{
    ...
    const W = new Set(["input", "textarea", "datalist", "select"])
      , U = new Set(["canvas", "body", "html"]);
    function B(e) {
        if (!e.target.tagName)
            return;
        const t = e.target.tagName.toLowerCase();
        U.has(t) && e.preventDefault()
    }
    function V(e) {
    ...
    self.C3_RasterSvgImageBlob = async function(e, t, i, s, n) {
        ...
        return o.width = s,
        o.height = n,
        o.getContext("2d").drawImage(a, 0, 0, t, i),
        o
    }
    ;
    let z = !1;
    ...
    document.addEventListener("pause", () => z = !0),
    document.addEventListener("resume", () => z = !1);
    const j = "runtime"
      , K = class extends self.DOMHandler {
        #e = -1;
        constructor(e) {
            super(e, j),
            ...
            this._isPollingGamepads = !1,
            this._pollGamepadRafCallback = () => this._OnPollGamepads(),
            this._gamepadInputCallbacks = new Set,
            ...
            if (window.addEventListener("contextmenu", e => {
                ...
                t.has(s) || F(i) || e.preventDefault()
            }
            ),
            window.addEventListener("selectstart", B),
            window.addEventListener("gesturehold", B),
        ...
        _OnBeforeStartTicking() {
            ...
            , 1e3),
            this._iRuntime.IsiOSWebView() && this._OnWindowResize(),
            ...
            this._pageVisibilityIsHidden = !("hidden" !== document.visibilityState && !z),
            {
        ...
        Attach() {
            ...
            window.addEventListener("focusin", e => {
                var t;
                t = e.target,
                (W.has(t.tagName.toLowerCase()) || F(t)) && this._PostRuntimeEvent("keyboard-blur")
            }
            ),
            window.addEventListener("keydown", e => this._OnKeyEvent("keydown", e)),
            window.addEventListener("keyup", e => this._OnKeyEvent("keyup", e)),
            window.addEventListener("mousedown", e => this._OnMouseEvent("mousedown", e, L)),
            window.addEventListener("mousemove", e => this._OnMouseEvent("mousemove", e, L)),
            window.addEventListener("mouseup", e => this._OnMouseEvent("mouseup", e, L)),
            window.addEventListener("dblclick", e => this._OnMouseEvent("dblclick", e, x)),
            window.addEventListener("wheel", e => this._OnMouseWheelEvent("wheel", e, x)),
            window.addEventListener("pointerdown", e => {
                this._HandlePointerDownFocus(e),
                this._OnPointerEvent("pointerdown", e)
            }
            ),
            this._iRuntime.UsesWorker() && void 0 !== window.onpointerrawupdate && self === self.top && !M ? window.addEventListener("pointerrawupdate", e => this._OnPointerRawUpdate(e)) : window.addEventListener("pointermove", e => this._OnPointerEvent("pointermove", e)),
            ...
            try {
                navigator.getGamepads().some(e => !!e) && (this._iRuntime._AddRAFCallback(this._pollGamepadRafCallback),
                this._isPollingGamepads = !0)
            } catch (e) {
                console.warn("[Construct] Unable to access gamepads for starting media playback: ", e)
            }
            window.addEventListener("gamepadconnected", () => this._OnGamepadConnected(), !0),
            window.addEventListener("gamepaddisconnected", () => this._OnGamepadDisconnected(), !0),
        ...
        _OnAndroidVirtualKeyboardChange(e, t) {
            ...
            t > 0) {
                ...
                if (i) {
                    ...
                    n > t && (n = t),
                    n < 0 && (n = 0),
                    n > 0 && (document.body.style.position = "absolute",
                    document.body.style.overflow = "visible",
                    document.body.style.transform = `translateY(${-n}px)`,
                    this._vkTranslateYOffset = n)
                }
            }
        }
        _PostRuntimeEvent(e, t) {
            this.PostToRuntime(e, t || null, D)
        }
        _GetWindowInnerWidth() {
        ...
        _OnWindowResize() {
            ...
            if (this._iRuntime.IsAndroidWebView())
                if (this._enableAndroidVKDetection) {
                    if (this._iRuntime.CanDoAndroidVirtualKeyboardDetection() && this._lastWindowWidth === e && t < this._lastWindowHeight)
                        return this._virtualKeyboardHeight = this._lastWindowHeight - t,
                    ...
                    this._OnAndroidVirtualKeyboardChange(t, this._virtualKeyboardHeight)),
                    this._lastWindowWidth = e,
                    this._lastWindowHeight = t
                } else
                    this._lastWindowWidth = e,
                    this._lastWindowHeight = t;
            ...
            this._iRuntime.IsiOSWebView() && this.#t(e, t, 0)
        }
        #t(e, t, i) {
            -1 !== this.#e && clearTimeout(this.#e),
            this.#e = setTimeout( () => this.#a(e, t, i), 100)
        }
        #a(e, t, i) {
            this.#e = -1;
            const s = this._GetWindowInnerWidth()
              , n = this._GetWindowInnerHeight();
            s !== e || n !== t ? this.PostToRuntime("window-resize", {
                innerWidth: s,
                innerHeight: n,
                devicePixelRatio: window.devicePixelRatio,
                isFullscreen: T.IsDocumentFullscreen(),
        ...
        _OnFullscreenChange() {
            if (this._isExportToVideo)
                return;
            const e = T.IsDocumentFullscreen();
        ...
        _OnKeyEvent(e, t) {
            if (void 0 === t.key)
                return;
            if ("Backspace" === t.key && B(t),
            "F5" === t.key && "windows-webview2" === this._iRuntime.GetExportType() && t.preventDefault(),
        ...
        _OnMouseEvent(e, t, i) {
            this._isExportToVideo || G(t) || this._PostToRuntimeMaybeSync(e, {
                button: t.button,
                buttons: t.buttons,
                clientX: t.clientX,
                clientY: t.clientY + this._vkTranslateYOffset,
        ...
        _OnGamepadConnected() {
            this._isPollingGamepads || (this._iRuntime._AddRAFCallback(this._pollGamepadRafCallback),
            this._isPollingGamepads = !0,
            this._OnAnyGamepadInput())
        }
        _OnGamepadDisconnected() {
            this._isPollingGamepads && navigator.getGamepads().every(e => !e) && (this._iRuntime._RemoveRAFCallback(this._pollGamepadRafCallback),
            this._isPollingGamepads = !1)
        }
        _OnPollGamepads() {
            navigator.getGamepads().some(e => e && e.buttons.some(e => e.pressed)) && this._OnAnyGamepadInput()
        }
        _OnAnyGamepadInput() {
            this._PlayPendingMedia();
            for (const e of this._gamepadInputCallbacks)
                e()
        }
        _AddAnyGamepadInputCallback(e) {
            this._gamepadInputCallbacks.add(e)
        }
        _RemoveAnyGamepadInputCallback(e) {
            this._gamepadInputCallbacks.delete(e)
        }
    ...
    ;
    T.AddDOMHandlerClass(K)
}
{
    const Y = "dispatchworker.js"
      , $ = "jobworker.js";
    self.JobSchedulerDOM = class {
        ...
        async Init() {
            ...
            const e = this._runtimeInterface.GetScriptFolder() + Y;
        ...
        async _CreateJobWorker() {
            const e = this._jobWorkers.length
              , t = this._runtimeInterface.GetScriptFolder() + $
...
{
    const Z = "touch"
      , J = class extends self.DOMHandler {
        constructor(e) {
            super(e, Z),
        ...
        async _OnRequestPermission(e) {
            const t = e.type;
            let i = !0;
            0 === t ? i = await this._RequestOrientationPermission() : 1 === t && (i = await this._RequestMotionPermission()),
    ...
    ;
    self.RuntimeInterface.AddDOMHandlerClass(J)
}
{
    const Q = "keyboard"
      , ee = class extends self.DOMHandler {
        constructor(e) {
            ...
            this.AddRuntimeMessageHandlers([["init", () => this._OnInit()], ["lock-keyboard", e => this._OnLockKeyboard(e)], ["unlock-keyboard", () => this._OnUnlockKeyboard()]])
        }
        _OnInit() {
            return {
...
}
{
    const te = "gamepad";
    let ie = !1;
    const se = class extends self.DOMHandler {
        constructor(e) {
            super(e, te),
            this._isReady = !1,
            this._timerId = -1,
            this.AddRuntimeMessageHandler("ready", () => this._OnReady()),
            this.AddRuntimeMessageHandler("vibrate-dual-rumble", e => this._OnGamepadVibrateDualRumble(e)),
            this.AddRuntimeMessageHandler("vibrate-trigger-rumble", e => this._OnGamepadVibrateTriggerRumble(e)),
            this.AddRuntimeMessageHandler("reset-vibrate", e => this._OnGamepadResetVibrate(e)),
            this.AddRuntimeMessageHandler("suspend", () => this._OnSuspend()),
            this.AddRuntimeMessageHandler("resume", () => this._OnResume()),
        ...
        _GetActiveGamepads() {
            try {
                ...
                return ie || (console.warn("[Construct] Failed to access gamepads: ", e),
                ie = !0),
                []
            }
        }
        _OnReady() {
            ...
            for (const e of this._GetActiveGamepads())
                this._PostGamepadConnectedEvent(e);
            this._StartGamepadPollTimer()
        }
        _StartGamepadPollTimer() {
            -1 === this._timerId && (this._timerId = setInterval( () => this._PollGamepadState(), 4))
        }
        _StopGamepadPollTimer() {
            -1 !== this._timerId && (clearInterval(this._timerId),
            this._timerId = -1)
        }
        _OnSuspend() {
            this._StopGamepadPollTimer()
        }
        _OnResume() {
            this._StartGamepadPollTimer()
        }
        _OnGamepadConnected(e) {
            this._isReady && this._PostGamepadConnectedEvent(e.gamepad)
        }
        _GetGamepadSupportedVibrationEffects(e) {
            const t = e.vibrationActuator;
            return t && t.playEffect && Array.isArray(t.effects) ? t.effects : []
        }
        _GetGamepadInfoJSON(e) {
            return {
                index: e.index,
                id: e.id,
                vibrationEffects: this._GetGamepadSupportedVibrationEffects(e)
            }
        }
        _PostGamepadConnectedEvent(e) {
            this.PostToRuntime("gamepad-connected", this._GetGamepadInfoJSON(e))
        }
        ...
        _PollGamepadState() {
            ...
            if (!e.length)
                return;
            const t = e.map(e => Object.assign(this._GetGamepadInfoJSON(e), {
        ...
        async _OnGamepadVibrateDualRumble(e) {
            ...
            if (i && i.playEffect)
                try {
                    ...
                    console.warn("[Gamepad] Failed to vibrate gamepad (dual rumble): ", e)
                }
        }
        async _OnGamepadVibrateTriggerRumble(e) {
            const t = this._GetGamepadByIndex(e.index);
            if (!t)
                return;
            const i = t.vibrationActuator;
            if (i && i.playEffect)
                try {
                    await i.playEffect("trigger-rumble", {
                        ...
                        weakMagnitude: e.weakMag,
                        strongMagnitude: e.strongMag,
                        leftTrigger: e.leftMag,
                        rightTrigger: e.rightMag
                    })
                } catch (e) {
                    console.warn("[Gamepad] Failed to vibrate gamepad (trigger rumble): ", e)
                }
        }
...
{
    const ne = "mouse"
      , ae = class extends self.DOMHandler {
        #e = !1;
        #t = !1;
        #r = "";
        constructor(e) {
            super(e, ne),
            this.AddRuntimeMessageHandlers([["init", e => this.#n(e)], ["cursor", e => this.#i(e)], ["request-pointer-lock", e => this.#a(e)], ["release-pointer-lock", () => this.#s()]]),
            document.addEventListener("pointerlockchange", e => this.#d()),
            document.addEventListener("pointerlockerror", e => this.#o())
        }
        #n(e) {
            this.#e = e.isPointerLockWrapperPolyfill,
            this.#e && (this._iRuntime._AddWrapperMessageHandler("set-pointer-lock-enabled-response", e => this.#h(e)),
            this._iRuntime._AddWrapperMessageHandler("pointer-lock-movement", e => this.#c(e)),
            window.addEventListener("blur", () => this.#u()))
        }
        #i(e) {
            this.#r = e,
            "linux-cef" === this._iRuntime.GetExportType() && this.#t || (document.documentElement.style.cursor = e)
        }
        #a(e) {
            this.#e ? ("linux-cef" === this._iRuntime.GetExportType() && (this.#t = !0,
        ...
        #s() {
            this.#e ? this._iRuntime._SendWrapperMessage({
                type: "set-pointer-lock-enabled",
                isEnabled: !1
        ...
        #h(e) {
            e.isOk ? (this.#t = e.isEnabled,
            this.PostToRuntime("pointer-lock-change", {
                hasPointerLock: e.isEnabled
            })) : (console.error(`[Mouse] Unable to obtain pointer lock (via wrapper): error ${e.error}`),
            this.#t = !1,
            this.PostToRuntime("pointer-lock-error", {
                hasPointerLock: !1
            })),
            "linux-cef" !== this._iRuntime.GetExportType() || this.#t || (document.documentElement.style.cursor = this.#r)
        }
        #c(e) {
            this.PostToRuntime("wrapper-pointer-lock-movement", {
    ...
    ;
    self.RuntimeInterface.AddDOMHandlerClass(ae)
}
...
let k = [{
    ...
    implementation: {
        ...
        setUpEventListeners(e, t) {
            let n = 0
              , a = t.poki_maxBeacons || 6
              , r = t.poki_beaconInterval || 60;
            const d = e => {
                if (t.poki_gameId && t.poki_doBeacon) {
                    ...
                    n = i,
                    a--,
                    navigator.sendBeacon(`https://leveldata.poki.io/${e}`, t.poki_gameId)
                }
            }
            ;
            p("loadingStart", () => {
...
const r = {
    ...
    init: (e, t=!1, i={}) => new Promise(async s => {
        if (a = k.find(t => t.name.toLowerCase() === e.toLowerCase()),
        a)
            if (S = !0,
            a.enableOnlyInProduction && t)
                S = !1,
                s();
            else if (a.implementation.preInit && await a.implementation.preInit(t, i),
            a.scriptSrc) {
                const e = async () => {
                    o = a.sdk,
                    a.implementation.setUpEventListeners(t, i),
                    a.implementation.init && await a.implementation.init(t, i),
                    r.loadingStart(),
                    s()
                }
                ;
                a.scriptSrc instanceof Array ? (await Promise.all(a.scriptSrc.map(e => new Promise(t => {
                    f(e, a.name + "-jssdk", t)
                }
                ))),
                e()) : f(a.scriptSrc, a.name + "-jssdk", e)
            } else
                s();
        else
            s()
    ...
    interstitial: () => (i.lastRequestedAd = "interstitial",
    a && a.hasAds && !a.noInterstitial ? new Promise(e => {
    ...
    Promise.resolve(!1))),
    rewarded: () => (i.lastRequestedAd = "rewarded",
    a && a.hasAds && !a.noRewarded ? new Promise(e => {
        let t = i.gameplayStarted;
        t && r.gameplayStop(),
        s("rewarded"),
        y("rewardedEnd", (...i) => {
    ...
    hasAds: () => a && a.hasAds ? 1 : 0,
    hasInterstitialAds: () => a && a.hasAds && !a.noInterstitial ? 1 : 0,
    hasRewardedAds: () => a && a.hasAds && !a.noRewarded ? 1 : 0,
    analyticsEvent({category: e, action: t, label: i}) {
        s("analyticsEvent", e, t, i)
    }
};
function E(e) {
...
));
{
    ...
    self.AudioDOMHandler = class extends self.DOMHandler {
        ...
        async _CreateAudioContext(e) {
            if (e.usePlayMusicAsSoundWorkaround && (this._playMusicAsSound = !0),
            ...
            this._lastListenerPos[0] = t[0],
            this._lastListenerPos[1] = t[1],
            this._lastListenerPos[2] = t[2],
            this._audioContext.listener.setPosition(t[0], t[1], t[2]),
        ...
        _AttachUnblockEvents() {
            ...
            this._iRuntime.AddAnyGamepadInputCallback(this._unblockFunc),
        ...
        _DetachUnblockEvents() {
            ...
            this._iRuntime.RemoveAnyGamepadInputCallback(this._unblockFunc),
        ...
        AddEffectForTag(e, t) {
            ...
            i || (i = [],
            this._effects.set(e, i)),
            t._SetIndex(i.length),
            t._SetTag(e),
            i.push(t),
        ...
        _ReconnectEffects(e) {
            ...
            for (const i of this.audioInstancesByEffectTag(e))
                i.Reconnect(t);
        ...
        ReleaseInstancesForBuffer(e) {
            ...
            for (let i = 0, s = this._audioInstances.length; i < s; ++i) {
                ...
                this._audioInstances[t] = s,
                s.GetBuffer() === e ? s.Release() : ++t
            }
        ...
        ReleaseAllMusicBuffersExceptLast() {
            ...
            for (let t = 0, i = this._audioBuffers.length; t < i; ++t) {
                ...
                this._audioBuffers[e] = i,
                i.IsMusic() && i !== this._lastMusicBuffer ? i.Release() : ++e
            }
        ...
        *audioInstancesMatchingTags(e) {
            if (e.length > 0)
                for (const t of this._audioInstances)
                    this._MatchTagLists(t.GetTags(), e) && (yield t);
            else
        ...
        *audioInstancesByEffectTag(e) {
            if (e)
                for (const t of this._audioInstances)
                    self.AudioDOMHandler.EqualsNoCase(t.GetEffectTag(), e) && (yield t);
            else
                this._lastAudioInstance && !this._lastAudioInstance.HasEnded() && (yield this._lastAudioInstance)
        }
        async _GetAudioBuffer(e, t, i, s, n) {
            for (const e of this._audioBuffers)
                if (e.GetUrl() === t)
                    return s && this._playMusicAsSound && (this._lastMusicBuffer = e),
                    await e.Load(),
                    e;
            if (n)
                return null;
            ...
            return this._audioBuffers.push(a),
            s && this._playMusicAsSound && (this._lastMusicBuffer = a),
            await a.Load(),
            this._loadedAudioUrls.has(e) || (this.PostToRuntime("buffer-metadata", {
                originalUrl: e,
                duration: a.GetDuration()
            }),
            this._loadedAudioUrls.add(e)),
            a
        }
        async _GetAudioInstance(e, t, i, s, n) {
            for (const e of this._audioInstances)
                if (e.GetUrl() === t && (e.CanBeRecycled() || n))
                    return n && this._playMusicAsSound && (this._lastMusicBuffer = e.GetBuffer()),
                    e.SetTags(s),
                    e;
            const a = await this._GetAudioBuffer(e, t, i, n);
            if (a.WasReleased())
                throw new Error(`buffer '${e}' unloaded while loading`);
            const o = a.CreateInstance(s);
            return this._audioInstances.push(o),
            o
        }
        _AddPendingTags(e) {
            const t = e.join(" ");
        ...
        _RemovePendingTags(e) {
            ...
            i.pendingCount--,
            0 === i.pendingCount && (i.resolve(),
            this._pendingTags.delete(t))
        }
        TagsReady(e) {
        ...
        async _Play(e) {
            const t = e.originalUrl
              ...
              , h = e.stereoPan;
            let c = e.off;
            c > 0 && !e.trueClock && (c += this.GetAudioCurrentTime()),
            this._lastPlayedTags = a.slice(0),
            this._AddPendingTags(a);
            try {
                this._lastAudioInstance = await this._GetAudioInstance(t, i, s, a, n),
                l ? (this._lastAudioInstance.SetPannerEnabled(!0),
                this._lastAudioInstance.SetPan(l.x, l.y, l.z, l.angle, l.innerAngle, l.outerAngle, l.outerGain),
                l.hasOwnProperty("uid") && this._lastAudioInstance.SetUID(l.uid)) : "number" == typeof h && 0 !== h ? (this._lastAudioInstance.SetStereoPannerEnabled(!0),
                this._lastAudioInstance.SetStereoPan(h)) : (this._lastAudioInstance.SetPannerEnabled(!1),
                this._lastAudioInstance.SetStereoPannerEnabled(!1)),
                this._lastAudioInstance.Play(o, r, d, c)
            } catch (e) {
        ...
        async _Stop(e) {
            ...
            for (const e of this.audioInstancesMatchingTags(t))
                e.Stop()
        }
        _StopAll() {
            for (const e of this._audioInstances)
        ...
        async _Unload(e) {
            ...
            const a = this._audioBuffers.indexOf(n);
            -1 !== a && this._audioBuffers.splice(a, 1)
        }
        _UnloadAll() {
            for (const e of this._audioBuffers)
                e.Release(),
                this._lastMusicBuffer === e && (this._lastMusicBuffer = null);
        ...
        _OnTick(e) {
            ...
            const t = e.listenerPos;
            !t || this._lastListenerPos[0] === t[0] && this._lastListenerPos[1] === t[1] && this._lastListenerPos[2] === t[2] || (this._lastListenerPos[0] = t[0],
            this._lastListenerPos[1] = t[1],
            this._lastListenerPos[2] = t[2],
            this._audioContext.listener.setPosition(t[0], t[1], t[2]));
            ...
            if (i && (this._lastListenerOrientation[0] !== i[0] || this._lastListenerOrientation[1] !== i[1] || this._lastListenerOrientation[2] !== i[2] || this._lastListenerOrientation[3] !== i[3] || this._lastListenerOrientation[4] !== i[4] || this._lastListenerOrientation[5] !== i[5])) {
                for (let e = 0; e < 6; ++e)
                    this._lastListenerOrientation[e] = i[e];
                this._audioContext.listener.setOrientation(...this._lastListenerOrientation)
            }
            for (const t of e.instPans) {
                const e = t.uid;
                for (const i of this._audioInstances)
                    i.GetUID() === e && i.SetPanXYZA(t.x, t.y, t.z, t.angle)
            }
        }
        async _AddEffect(e) {
            const t = e.type
            ...
            for (const o of i) {
                if ("filter" === t)
                    n = new self.C3AudioFilterFX(this,...s);
                else if ("delay" === t)
                    n = new self.C3AudioDelayFX(this,...s);
                else if ("convolution" === t)
                    n = new self.C3AudioConvolveFX(this,a.GetAudioBuffer(),...s),
                    n._SetBufferInfo(e.bufferOriginalUrl, e.bufferUrl, e.bufferType);
                else if ("flanger" === t)
                    n = new self.C3AudioFlangerFX(this,...s);
                else if ("phaser" === t)
                    n = new self.C3AudioPhaserFX(this,...s);
                else if ("gain" === t)
                    n = new self.C3AudioGainFX(this,...s);
                else if ("stereopan" === t)
                    n = new self.C3AudioStereoPanFX(this,...s);
                else if ("tremolo" === t)
                    n = new self.C3AudioTremoloFX(this,...s);
                else if ("ringmod" === t)
                    n = new self.C3AudioRingModFX(this,...s);
                else if ("distortion" === t)
                    n = new self.C3AudioDistortionFX(this,...s);
                else if ("compressor" === t)
                    n = new self.C3AudioCompressorFX(this,...s);
                else {
                    if ("analyser" !== t)
        ...
        _DoPostUpdatedFxState() {
            const e = {};
            for (const [t,i] of this._effects)
                e[t] = i.map(e => e.GetState());
        ...
        async _OnLoadState(e) {
            ...
            if (3 !== t) {
                const e = [];
                for (const i of this._audioInstances)
                    i.IsMusic() && 1 === t || !i.IsMusic() && 2 === t ? e.push(i) : i.Release();
            ...
            this._lastListenerPos[0] = i[0],
            this._lastListenerPos[1] = i[1],
            this._lastListenerPos[2] = i[2],
            this._audioContext.listener.setPosition(i[0], i[1], i[2]);
            const s = e.listenerOrientation;
            if (Array.isArray(s)) {
                for (let e = 0; e < 6; ++e)
                    this._lastListenerOrientation[e] = s[e];
                this._audioContext.listener.setOrientation(...this._lastListenerOrientation)
            }
            this._isSilent = e.isSilent,
            this._iRuntime.SetSilent(this._isSilent),
            ...
            for (const t of Object.values(e.effects))
                n.push(Promise.all(t.map(e => this._AddEffect(e))));
            await Promise.all(n),
        ...
        async _LoadAudioInstance(e, t) {
            ...
            h.LoadPanState(e.pan),
            h.LoadStereoPanState(e.stereoPan),
            h.Play(r, d, l, 0),
            e.isPlaying || h.Pause(),
            h._LoadAdditionalState(e)
        }
        ...
        async _OnOfflineRenderAudio(e) {
            try {
                ...
                this._hasStartedOfflineRender ? this._audioContext.resume() : (this._audioContext.startRendering().then(e => this._OnOfflineRenderCompleted(e)).catch(e => this._OnOfflineRenderError(e)),
...
self.C3WebAudioBuffer = class extends self.C3AudioBuffer {
    ...
    async _Fetch() {
        ...
        if ("playable-ad-single-file" === e.GetExportType() && e.IsRelativeURL(this._url)) {
    ...
    async _Decode() {
        ...
        this._audioBuffer = await e.decodeAudioData(this._audioData),
        this._audioData = null
    }
    async _Load() {
        try {
            ...
            console.error(`[Construct] Failed to load audio '${this._url}': `, e)
        }
    }
    IsLoaded() {
    ...
    self.C3AudioInstance = class {
        ...
        FadeVolume(e, t, i) {
            ...
            const n = this._audioDomHandler.GetAudioCurrentTime()
              , a = n + t;
            s.setValueAtTime(s.value, n),
            s.linearRampToValueAtTime(e, a),
            this._volume = e,
            this._fadeEndTime = a,
            this._stopOnFadeEnd = i
        }
        _UpdateVolume() {
        ...
        SetPan(e, t, i, s, n, a, o) {
            ...
            this._pannerConeParams[0] !== r(n) && (this._pannerConeParams[0] = r(n),
            this._pannerNode.coneInnerAngle = r(n)),
        ...
        SetPanXYZA(e, t, i, s) {
            ...
            const n = this._pannerPosition
              ...
              , o = Math.cos(s)
              , r = Math.sin(s);
            n[0] === e && n[1] === t && n[2] === i || (n[0] = e,
            n[1] = t,
            n[2] = i,
            this._pannerNode.setPosition(...n)),
        ...
        LoadPanState(e) {
            ...
            const t = this._pannerNode
              , i = e.pos;
            this._pannerPosition[0] = i[0],
            this._pannerPosition[1] = i[1],
            this._pannerPosition[2] = i[2];
            const s = e.orient;
            this._pannerOrientation[0] = s[0],
            this._pannerOrientation[1] = s[1],
            this._pannerOrientation[2] = s[2],
...
self.C3Html5AudioInstance = class extends self.C3AudioInstance {
    ...
    Play(e, t, i, s) {
        ...
        this._audioDomHandler.TryPlayMedia(n),
        this._isStopped = !1,
        this._isPaused = !1,
        this._isLooping = e,
        this._playbackRate = 1
...
;
{
    ...
    self.C3AudioFilterFX = class extends le {
        constructor(e, t, i, s, n, a, o) {
            super(e),
            this._type = "filter",
            this._params = [t, i, s, n, a, o],
            this._inputNode = this.CreateGain(),
            this._wetNode = this.CreateGain(),
            this._wetNode.gain.value = o,
            this._dryNode = this.CreateGain(),
            this._dryNode.gain.value = 1 - o,
    ...
    ,
    self.C3AudioDelayFX = class extends le {
        constructor(e, t, i, s) {
            super(e),
            this._type = "delay",
            this._params = [t, i, s],
        ...
        SetParam(e, t, i, s) {
            ...
            case 4:
                this._params[1] = n(t),
                this.SetAudioParam(this._delayGainNode.gain, n(t), i, s);
                break;
            case 5:
                this._params[0] = t,
    ...
    ,
    self.C3AudioConvolveFX = class extends le {
        constructor(e, t, i, s) {
            super(e),
    ...
    ,
    self.C3AudioFlangerFX = class extends le {
        constructor(e, t, i, s, n, a) {
            super(e),
            this._type = "flanger",
            this._params = [t, i, s, n, a],
            this._inputNode = this.CreateGain(),
            this._dryNode = this.CreateGain(),
    ...
    ,
    self.C3AudioPhaserFX = class extends le {
        constructor(e, t, i, s, n, a, o) {
            super(e),
            this._type = "phaser",
            this._params = [t, i, s, n, a, o],
            this._inputNode = this.CreateGain(),
            this._dryNode = this.CreateGain(),
            this._dryNode.gain.value = 1 - o / 2,
            this._wetNode = this.CreateGain(),
            this._wetNode.gain.value = o / 2,
            this._filterNode = this._audioContext.createBiquadFilter(),
    ...
    ,
    self.C3AudioGainFX = class extends le {
        constructor(e, t) {
            super(e),
            this._type = "gain",
            this._params = [t],
        ...
        SetParam(e, t, i, s) {
            const n = self.AudioDOMHandler.DbToLinear;
            4 === e && (this._params[0] = n(t),
            this.SetAudioParam(this._node.gain, n(t), i, s))
        }
    }
    ,
    self.C3AudioStereoPanFX = class extends le {
        constructor(e, t) {
            super(e),
        ...
        SetParam(e, t, i, s) {
            ...
            9 === e && (this._params[0] = t,
            this.SetAudioParam(this._node.pan, t, i, s))
        }
    }
    ,
    self.C3AudioTremoloFX = class extends le {
        constructor(e, t, i) {
            super(e),
            this._type = "tremolo",
            this._params = [t, i],
    ...
    ,
    self.C3AudioRingModFX = class extends le {
        constructor(e, t, i) {
            super(e),
            this._type = "ringmod",
            this._params = [t, i],
    ...
    ,
    self.C3AudioDistortionFX = class extends le {
        constructor(e, t, i, s, n, a) {
            super(e),
    ...
    ,
    self.C3AudioCompressorFX = class extends le {
        constructor(e, t, i, s, n, a) {
            super(e),
    ...
    ,
    self.C3AudioAnalyserFX = class extends le {
        constructor(e, t, i) {
            super(e),
            this._type = "analyser",
            this._params = [t, i],
...
}
{
    ...
    const pe = class extends self.DOMHandler {
        constructor(e) {
            super(e, he),
        ...
        async _OnGetInitialState() {
            const e = await this._GetSafeAreaInset();
            return {
        ...
        async _GetSafeAreaInset() {
            const e = self.AndroidNotch;
            if (!e) {
                const e = document.body
                  , t = e.style;
                t.setProperty("--temp-sai-top", "env(safe-area-inset-top)"),
                t.setProperty("--temp-sai-right", "env(safe-area-inset-right)"),
                t.setProperty("--temp-sai-bottom", "env(safe-area-inset-bottom)"),
                t.setProperty("--temp-sai-left", "env(safe-area-inset-left)");
                ...
                return t.removeProperty("--temp-sai-top"),
                t.removeProperty("--temp-sai-right"),
                t.removeProperty("--temp-sai-bottom"),
                t.removeProperty("--temp-sai-left"),
                s
            }
            try {
                return await Promise.all([ce(e), ue(e), _e(e), me(e)])
            } catch (e) {
                return console.error("[Construct] Failed to get Android safe area inset: ", e),
                [0, 0, 0, 0]
            }
        }
        async _OnResize() {
        ...
        async _OnRequestWakeLock() {
            if (!this._screenWakeLock)
                try {
                    ...
                    console.warn("[Construct] Failed to acquire screen wake lock: ", e),
                    this.PostToRuntime("wake-lock-error")
                }
        }
        _OnReleaseWakeLock() {
            this._screenWakeLock && (this._screenWakeLock.release(),
            this._screenWakeLock = null)
        }
        _OnWakeLockReleased() {
    ...
    ;
    self.RuntimeInterface.AddDOMHandlerClass(pe)
}
{
    const fe = "localstorage"
      , ge = class extends self.DOMHandler {
        constructor(e) {
            super(e, fe),
        ...
        async _Init() {
            let e = !1;
            try {
                e = await navigator.storage.persisted()
            } catch (t) {
                e = !1,
                console.warn("[Construct] Error checking storage persisted state: ", t)
            }
            return {
                isPersistent: e
            }
        ...
        async _OnRequestPersistent() {
            try {
                ...
                return console.error("[Construct] Error requesting persistent storage: ", e),
                {
                    isOk: !1
                }
            }
    ...
    ;
    self.RuntimeInterface.AddDOMHandlerClass(ge)
}
{
    let we = null
      , ye = null;
    ...
    we = e,
    ye && ye._OnBeforeInstallPrompt(),
    !1));
    const Se = "browser"
      , Pe = class extends self.DOMHandler {
        constructor(e) {
            super(e, Se),
            this._exportType = "",
        ...
        Attach() {
            we ? this._OnBeforeInstallPrompt() : ye = this,
        ...
        async _OnRequestInstall() {
            ...
            try {
                return we.prompt(),
                {
                    result: (await we.userChoice).outcome
                }
            } catch (e) {
        ...
        _OnRequestFullscreen(e) {
            if (this._iRuntime.IsAnyWebView2Wrapper() || "macos-wkwebview" === this._exportType || "linux-cef" === this._exportType)
                ...
                let n;
                s.requestFullscreen ? n = s.requestFullscreen(t) : s.mozRequestFullScreen ? n = s.mozRequestFullScreen(t) : s.msRequestFullscreen ? n = s.msRequestFullscreen(t) : s.webkitRequestFullScreen && (n = void 0 !== Element.ALLOW_KEYBOARD_INPUT ? s.webkitRequestFullScreen(Element.ALLOW_KEYBOARD_INPUT) : s.webkitRequestFullScreen()),
                n instanceof Promise && n.catch(be)
            }
        }
        _OnFullscreenError() {
            this.PostToRuntime("fullscreenerror")
        ...
        _OnExitFullscreen() {
            if (this._iRuntime.IsAnyWebView2Wrapper() || "macos-wkwebview" === this._exportType || "linux-cef" === this._exportType)
                ...
                e instanceof Promise && e.catch(be)
            }
        }
        _OnSetHash(e) {
        ...
        _OnSetDocumentCSSStyle(e) {
            ...
            try {
                const e = ve(s, n);
                for (const s of e)
                    t.startsWith("--") ? s.style.setProperty(t, i) : s.style[t] = i
            } catch (e) {
